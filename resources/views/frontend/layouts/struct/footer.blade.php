        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-3 col-xs-12 ">
                    <div class="photo">
                        <a href="#"><img src="{{ Resizer::get($settings['logo'], 260, 87) }}" alt="images" class="img-responsive"></a>
                    </div>
                    <div class="widget-info">
                        <ul>
                            <li><i class="ion-ios-location fa-4" aria-hidden="true"></i>{{$settings['address']}}</li>
                            <li class="clearfix"></li>
                            <li><i class="ion-ios-telephone fa-4" aria-hidden="true"></i>
                                <p class="title-contain">{{$settings['phone']}}</p>
                            </li>
                            <li class="clearfix"></li>
                            <li><i class="ion-email-unread fa-4" aria-hidden="true"></i>
                                <p class="title-contain">{{$settings['email']}}</p>
                            </li>
                            <li class="clearfix"></li>
                        </ul>
                    </div>
