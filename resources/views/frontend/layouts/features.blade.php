    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12 fea-column-inner">
                <div class="fea-box">
                    <div class="photo">
                        <img src="{{asset('img/gift.png')}}" alt="images" class="img-reponsive">
                    </div>
                    <p class="inform-ver2">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 fea-column-inner">
                <div class="fea-box">
                    <div class="photo">
                        <img src="{{asset('img/fly.png')}}" alt="images" class="img-reponsive">
                    </div>
                    <p class="inform-ver2">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 fea-column-inner">
                <div class="fea-box">
                    <div class="photo">
                        <img src="{{asset('img/return.png')}}" alt="images" class="img-reponsive">
                    </div>
                    <p class="inform-ver2">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 fea-column-inner">
                <div class="fea-box">
                    <div class="photo">
                        <img src="{{asset('img/secu.png')}}" alt="images" class="img-reponsive">
                    </div>
                    <p class="inform-ver2">
